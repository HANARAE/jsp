...
<%!
    	...
    	선언자에 작성한 코드는 jsp파일이 클래스로 변환될 때 클래스 블록에 선언된다.
    	*/
...
<%
    	...
    	스트립틀릿에 작성한 내용은 jsp파일이 클래스로 변환될 때 jsp_service()라는 메서드 내부에 작성된다.
...
<body>
	...
	<!-- 
		expression(표현자)
		jsp 페이지 내에서 사용되는 변수의 값 또는 메서드의 리턴값을 브라우저에 바로 출력할 때 사용하는 태그.
		결과값 타입 -> String
