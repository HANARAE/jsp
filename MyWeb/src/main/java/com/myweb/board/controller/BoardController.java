	...
	protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		case "regist":
			...
			/*
			 ...
			 board_list.jsp에는 데이터베이스로부터 전체 글 목록을 가져오는 로직을 작성하지 않을 것이기 때문.
			 (jsp는 단순히 보여지는 역할만 수행)
			 컨트롤러고 글 목록 요청이 다시 들어올 수 있게끔 sendRedirect()를 사용하여
			 자동 목록 재 요청이 들어오게 하는 것이다.
			 */
		...
		case "list":
			...
			/*
			 ...
			 응답이 바로 나가면서 request 객체가 소멸해 버린다.
